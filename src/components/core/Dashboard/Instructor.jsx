  ...
  return (
    <div>
      <div className="flex justify-between">
        ...
        <div className="text-3xl font-bold text-richblack-5">{user.accountType} Dashboard</div>
      </div>
      {
        loading ? (<div className="grid h-[calc(100vh-3.5rem)] min-w-[220px] items-center border-r-[1px] border-r-richblack-700 bg-richblack-800">
